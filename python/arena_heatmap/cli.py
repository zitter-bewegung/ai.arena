...
def main():
    ...
    for preset in presets:
        ...
        occupancy, deaths = collect(client, preset, args.games)
        for aggregator, kind in ((occupancy, "moves"), (deaths, "deaths")):
            heatmaps = aggregator.heatmaps
            png_path = render_figure(preset, heatmaps, args.games, args.outdir, kind=kind)
            json_path = save_json(preset, heatmaps, args.games, args.outdir, kind=kind)
